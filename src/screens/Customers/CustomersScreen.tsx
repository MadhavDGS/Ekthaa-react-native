...
const styles = StyleSheet.create({
  ...
  input: { flex: 1, fontSize: Typography.fontXs, marginLeft: Spacing.xs, height: 32 },
  ...
  avatar: { width: 34, height: 34, borderRadius: 17, justifyContent: 'center', alignItems: 'center', marginRight: Spacing.sm },
